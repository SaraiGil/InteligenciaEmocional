...
function playMusic()
{
	...
	audio.src = "assets/music/" + song[numCancion].archivo;
	audio.play();
}
...
function live(welcome=true)
{
	...
	[
		...
		"Buenos días",
		"Bienvenido",
		"¿Cómo te va?<br><button onclick='say(\"Perfecto, sigue así\")'>Bien</button><button onclick='motivate()'>Meh!</button><button onclick='cheerUp()'>Mal</button>",
		"Es bueno volver a verte",
		"Encantada",
		"Como no hay nadie que nos presente, me presento: soy Eric",
		"Mi nombre es Eric, Eric el ericzo",
		"Hola mundo",
		"Te extrañé",
		"No te he olvidado",
		"Estás deslumbrante",
		"¿Cómo te sientes?<br><button onclick='say(\"Mantén una actitud positiva\")'>Bien</button><button onclick='motivate()'>Meh!</button><button onclick='cheerUp()'>Mal</button>",
		...
		"¿Te sientes bien?<br><button onclick='say(\"Sólo estaba checando, sonrie\")'>Sí</button><button onclick='cheerUp()'>No</button>",
		"¿Ya comiste?<br><button onclick='say(\"Mantén una buena alimentación e hidratate\")'>Sí</button><button onclick='say(\"Ve a comer algo si lo necesitas, necesitamos energia para todas las tareas de nuestra vida cotidiana\")'>No</button>",
		"¿Eres feliz?<br><button onclick='say(\"Siempre hay que estar felices, sigue así\")'>Sí</button><button onclick='cheerUp()'>No</button>",
		"Te esperaba ansiosamente",
		"Pasa, pasa",
		"Siéntase como en su casa",
		"¿Acabaste la tarea?<br><button onclick='say(\"Perfecto, recuerda tomar un descanso de la computadora, celular y otras pantallas\")'>Sí</button><button onclick='say(\"Hay que terminar las tareas a tiempo y forma lo más pronto posible para evitar estrés innecesario\")'>No</button>",
		...
		"¿Llego en mal momento?<br><button onclick='walkOut()'>Sí</button><button onclick='cheerUp()'>No</button>",
		"¿Interrumpo?<br><button onclick='walkOut()'>Sí</button><button onclick='cheerUp()'>No</button>",
		...
		"¿Te molesta si te acompaño?<br><button onclick='walkOut'>Sí</button><button onclick='cheerUp()'>No</button>",
	...
	video =
	[
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/8Dnw5Mmxzc8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/rQ4MEmvc3a0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/7q0_eTyX_bs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
	];

	if (welcome)
	{
		setTimeout(walkIn, 1000);
		setTimeout(function(){ say("Hola, mi nombre es Eric, seré tu compañero en este viaje. Mucho gusto.<br>Para quitar este mensaje puedes hacerme click a mí o a la \"X\" situada a la izquierda<br>Espero hacer tu estancia placentera."); }, 2000);
	}
	else
	{
		thinkWhenShouldIComeBack();
	}
}